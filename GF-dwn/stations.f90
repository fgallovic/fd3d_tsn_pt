...
!   --------
    ...
    REAL*8 x,y,lat,long,staazimuth,statakeoff
...
10  read(110,*,END=12)lat,long,staname !,staazimuth,statakeoff
    CALL POISTA(lat,long,reflat,reflong,x,y)
    write(111,*)x,y,0.,staname !,staazimuth,statakeoff    !Station co-ordinates  x(N>0,km),y(E>0,km),z(km)
    goto 10
12  continue
